...
def get_ground_range(initial_lat_deg,initial_lon_deg,initial_ut1,current_r_eci,talo_sec):
    """
    SUMMARY.
    ...
    -------
    float
        ground range from launch point in meters
    """
    ...
    v_i_dict = vincenty_inverse(initial_lat_deg,initial_lon_deg,current_lat_deg,current_lon_deg)
    return v_i_dict['distance_m']
