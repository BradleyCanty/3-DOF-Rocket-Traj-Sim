...
Description:
    Implement an altitude-varying air density in the 1D rocket trajectory simulation.
    ...
    To get started, create a new file named 'atmosphere_fxns.py' and implement the 
    formula in a function. Then, check its accuracy by comparing it to 
    tabulated U.S. Standard Atmosphere data (https://www.engineeringtoolbox.com/standard-atmosphere-d_604.html#gsc.tab=0)
    
    Then, import the function into the 'math_fxns.py' file and use it in the system 
    of ODEs.
    
    Finally, plot the rocket's acceleration, velocity, and position as a function 
    of time.
