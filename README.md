...
4) Add noise to ICBM state vector, then extend kill vehicle's Lambert intercept guidance solution with proportional navigation homing to null the Predicted Intercept Point errors
